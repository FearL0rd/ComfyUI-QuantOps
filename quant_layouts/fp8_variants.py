...
class RowWiseFP8Layout(QuantizedLayout):
    ...
    @classmethod
    def quantize(cls, tensor, scale=None, dtype=torch.float8_e4m3fn, **kwargs) -> Tuple[torch.Tensor, Dict]:
        """
...
class BlockWiseFP8Layout(QuantizedLayout):
    ...
    @classmethod
    def quantize(cls, tensor, scale=None, block_size=64, dtype=torch.float8_e4m3fn, **kwargs) -> Tuple[torch.Tensor, Dict]:
        """
